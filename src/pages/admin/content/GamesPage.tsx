        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50">
              ...
              <th className="px-4 py-3 font-semibold text-slate-600">评分</th>
              <th className="px-4 py-3 font-semibold text-slate-600">配置</th>
              <th className="px-4 py-3 font-semibold text-slate-600">平台</th>
            ...
            {loading ? (
              ...
              filtered.map((item) => (
                <tr key={item.id} className="border-b border-slate-50 hover:bg-slate-50/50">
                  ...
                  <td className="px-4 py-3 text-slate-600">{item.rating.toFixed(1)}</td>
                  <td className="px-4 py-3 text-slate-600">{configLabel(item.config)}</td>
