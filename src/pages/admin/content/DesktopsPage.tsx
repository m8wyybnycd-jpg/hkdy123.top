        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50">
              ...
              <th className="px-4 py-3 font-semibold text-slate-600">价格区间</th>
              <th className="px-4 py-3 font-semibold text-slate-600">使用场景</th>
            ...
            {loading ? (
              ...
              filtered.map((item) => (
                <tr key={item.id} className="border-b border-slate-50 hover:bg-slate-50/50">
                  ...
                  <td className="px-4 py-3 text-slate-600">{item.priceRange}</td>
            ...
            <div className="flex-1 space-y-4 overflow-y-auto p-5">
              <FormField label="ID" required>
                <input
                  ...
                  disabled={!!editing}
                  className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-[#3b9eff] focus:outline-none focus:ring-1 focus:ring-[#3b9eff] disabled:bg-slate-50 disabled:text-slate-400"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-500">
              确定要删除 <span className="font-medium text-slate-700">{deleteTarget.name}</span> 吗？
            </p>
